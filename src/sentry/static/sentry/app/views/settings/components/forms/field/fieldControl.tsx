...
type Props = Partial<typeof defaultProps> & {
  ...
  alignRight?: boolean;
  /**
   * Loading / Saving / Error statest of the form. See the ControlState
   */
  ...
  /**
   * The error state. Will not be rendered if hideControlState is trued
   */
  errorState?: React.ReactNode;
  /**
   * Allow the control state to flex based on it's content. When enabled the
